      ...
      <section className="blogs">
        ...
        <div className="blog_entries">
          <div className="entry left">
            <img className="blog_image" src="/blog_image_left.png"></img>
            <div className="blog_wrapper">
              ...
              <div className="lower_blog">
                ...
                <div className="blog_icon_div">
                  <img className="blog_icon" src="/Rectangle_Icon.svg"></img>
                  <img className="blog_icon" src="/Heart_Icon.svg"></img>
                </div>
              </div>
            </div>
          </div>
          <div className="entry right">
            <img className="blog_image" src="/blog_image_right.png"></img>
            <div className="blog_wrapper">
              <p>Mindful Eating</p>
